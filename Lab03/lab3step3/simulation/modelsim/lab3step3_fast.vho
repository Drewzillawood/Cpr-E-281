...
SIGNAL \ALT_INV_Alarm~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\ALT_INV_Alarm~0_combout\ <= NOT \Alarm~0_combout\;
...
\Alarm~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \Alarm~0_combout\ = (\a~combout\ & ((\d~combout\) # ((\c~combout\ & \b~combout\)))) # (!\a~combout\ & (((!\c~combout\ & !\b~combout\)) # (!\d~combout\)))
...
-- pragma translate_on
PORT MAP (
	datain => \ALT_INV_Alarm~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
