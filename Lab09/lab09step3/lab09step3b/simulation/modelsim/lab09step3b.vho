...
ARCHITECTURE structure OF lab09step3b IS
...
-- Equation(s):
-- \inst|inst4~1_combout\ = (GLOBAL(\clock~clkctrl_outclk\) & (\inst|inst4~1_combout\)) # (!GLOBAL(\clock~clkctrl_outclk\) & ((!\D~combout\)))
...
-- Equation(s):
-- \inst1|inst4~1_combout\ = (GLOBAL(\clock~clkctrl_outclk\) & ((\inst|inst4~1_combout\))) # (!GLOBAL(\clock~clkctrl_outclk\) & (\inst1|inst4~1_combout\))
